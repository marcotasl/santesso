        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="mt-8">
              <a
                ...
                className="btn-shine inline-flex items-center justify-center gap-2 rounded-full bg-[var(--color-primary)] px-8 py-4 text-base font-semibold text-white hover:bg-[var(--color-primary-dark)] transition-colors shadow-lg shadow-orange-900/30"
              >
                ...
                Solicitar orçamento rápido no WhatsApp
              </a>
              <div className="mt-3 flex items-center gap-2 text-base font-bold text-green-300">
          ...
          <div className="hidden lg:flex items-center justify-center relative">
            <div className="relative">
              ...
              <div className="absolute -left-8 top-12 rounded-xl bg-black/40 backdrop-blur-lg border border-white/15 px-5 py-4 shadow-lg max-w-[200px]">
              ...
              <div className="absolute -right-8 bottom-16 rounded-xl bg-black/40 backdrop-blur-lg border border-white/15 px-5 py-4 shadow-lg max-w-[200px]">
